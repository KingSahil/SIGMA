...
Preserves the exact DSP pipeline: file_source -> time_sink, freq_sink, constellation_sink.
"""
...
class SigmaFlowgraph(gr.top_block):
    ...
    def _build_pipeline(self):
        ...
        # Use existing file if available, otherwise dummy fallback
