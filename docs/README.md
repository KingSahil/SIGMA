...
| **[Done vs. Remaining](file:///c:/Users/sahil/Downloads/gnu/docs/STATUS_DONE_VS_LEFT.md)**                          | One-screen status table: every finished item with its test, every open item with its size and blocker.                                              |
